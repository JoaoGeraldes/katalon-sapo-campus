...
// Modificar imagem da capa do grupo
selenium.click("xpath=(.//*[normalize-space(text()) and normalize-space(.)='Notificações'])[1]/following::button[1]")
selenium.type("xpath=(.//*[@id='app']/div/div/div[2]/div[1]/header/div/div[1]/div[3]/div/div[2]/div/div/button", "C:\\Utilizadores\\Jow\\Imagens\\225-1200x225.jpg")
selenium.click("xpath=(.//*[normalize-space(text()) and normalize-space(.)='Guardar'])[1]/following::div[1]")
